		...
		if ($this->input->is_ajax_request()) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				if ($this->crud_model->insert_entry($ajax_data)) {
					$data = array('responce' => 'success', 'message' => 'Registro añadido exitosamente');
				} else {
					$data = array('responce' => 'error', 'message' => 'Falló el registro');
				}
			}
		...
		if ($this->input->is_ajax_request()) {
			...
			if ($this->form_validation->run() == FALSE) {
				...
				if ($this->crud_model->update_entry($data)) {
					$data = array('responce' => 'success', 'message' => 'Registro actualizado');
				} else {
					$data = array('responce' => 'error', 'message' => 'Falló al actualizar el registro');
				}
			}
